...
extension UIColor {
    ...
    @nonobjc class var acronymsDisable: UIColor {
        return UIColor(named: "acronymsDisable") ?? .init(hex: "ADADAD")
    }
    
    // MARK: - Primary
    
    @nonobjc class var acronymsPrimary: UIColor {
        return UIColor(named: "acronymsPrimary") ?? .init(hex: "343EFF")
    }
    
    @nonobjc class var acronymsPrimaryAlpha5: UIColor {
        return UIColor(named: "acronymsPrimary-alpha-5") ?? UIColor.acronymsPrimary.withAlphaComponent(0.05)
    }

    @nonobjc class var acronymsPrimaryAlpha10: UIColor {
        return UIColor(named: "acronymsPrimary-alpha-10") ?? UIColor.acronymsPrimary.withAlphaComponent(0.10)
    }
    
    // MARK: - Secondary
    @nonobjc class var acronymsSecondary: UIColor {
        return UIColor(named: "acronymsSecondary") ?? .init(hex: "ED881D")
    }
    
    // MARK: - Surface
    @nonobjc class var acronymsSurface: UIColor {
        return UIColor(named: "acronymsSurface") ?? .init(hex: "FAFAFA")
    }
